...
import Minilisp.AST
       (Atom, AST(Application, Atom, Char', Int', Lambda, String'),
...
normalizeAST (RawString string) = return $ SugaredString string
